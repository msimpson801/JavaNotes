...
Let's look at a method which might appear in our Restaurant class which _determines_ the appropriate type of pizza and then goes about _making_ the pizza:
